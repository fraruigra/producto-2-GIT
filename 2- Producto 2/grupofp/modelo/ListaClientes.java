        ...
        for (Clientes cliente : this.getArrayList()) {
            if (cliente.tipoCliente().equals(tipoCliente)) {
                if (tipoCliente.equals("ClientePremium")) {
                    ClientePremium nuevoCliente = new ClientePremium(tipoCliente, tipoCliente, tipoCliente,
                            tipoCliente);
                    cl.add(nuevoCliente);
                } else {
                    ClienteEstandar nuevoCliente = new ClienteEstandar(tipoCliente, tipoCliente, tipoCliente,
                            tipoCliente);
                    cl.add(nuevoCliente);
                }
            }
